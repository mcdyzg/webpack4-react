...
const Counter = DynamicImport(() => import(/* webpackChunkName: "Counter" */'@pages/Counter'))

// dynamic import实现异步加载
const AsyncPage = DynamicImport(() => import(/* webpackChunkName: "AsyncPage" */'@pages/AsyncPage'))
